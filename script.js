window.onload = function(){
    ...
    function gameOver(){
        ...
        ctx.strokeText("GAME OVER", centreX,centreY - 190);
        ctx.fillText("GAME OVER", centreX, centreY - 190);
        ctx.font = "bold 40px sans-serif";
        ctx.fillText("Appuyer sur le touche Espace pour rejouer", centreX, centreY - 130);
        ctx.restore();
    }
    function restart(){
        snakee = new Snake([[6,4], [5,4], [4,4]], "right");
